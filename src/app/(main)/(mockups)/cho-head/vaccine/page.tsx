...
import Requests from "./_components/approval";
import Inventory from "./_components/inventory";
import VaccineItems from "./_components/Items";
import Issuances from "./_components/issuances";
import { ChevronRight } from "lucide-react";
import Oversight from "./_components/oversight";

interface Props {
    searchParams: Promise<{ tab: 'inventory' | 'request' | 'issuance' | 'items' | 'oversight'}>
}
