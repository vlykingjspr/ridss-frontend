...
import EventCalendar from "../../bhw-staff/schedule/_components/event-calendar";
    ...
    return (
        <div className="">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
                <Card className="shadow-xs rounded-md gap-0 p-3 overflow-hidden max-h-120">
                ...
                <div className="col-span-full h-[calc(100vh-6rem)] grid">
                    <EventCalendar />
                </div>
            </div>
        </div>
